...
\begin{itemize}
    \item[(a)] Here openCV filter2D function is used to carry out the sobel filter on Einstein image. Sobel kernels detect the
            edges of a given image. As you can observe on the figure \ref{51} Sobel vertical kernel detects the horizontal edges while 
